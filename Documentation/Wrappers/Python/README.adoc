...
|link:../../../Python/examples/octopus_energy_set_tariff.py[`octopus_energy_set_tariff.py`]
|None
|https://octopus.energy/dashboard/new/accounts/personal-details/api-access[Octopus Energy API]
|Cloud
|Aquires utility tariff information from Octopus Energy, converts to a Tesla Tariff and uploads it to Tesla. It also displays data on the console/terminal then exits. Will attempt to refresh any expired tokens.

|link:../../../Python/examples/tesla_generate_docs.py[`tesla_generate_docs.py`]
|None
|Static JSON File
|Documentation Files
|This is a project resource to semi-automatically generate the documentation files.

|link:../../../Python/examples/tesla_jwks_convert.py[`tesla_jwks_convert.py`]
|None
|Cloud
|Console
