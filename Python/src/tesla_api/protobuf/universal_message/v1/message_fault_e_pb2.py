...
# source: tesla_api/protobuf/universal_message/v1/message_fault_e.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'tesla_api/protobuf/universal_message/v1/message_fault_e.proto'
)
